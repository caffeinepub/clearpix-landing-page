    ...
    <div className="bg-white min-h-screen text-black">
      ...
      <section className="pt-28 pb-10 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <FadeSection>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-[52px] font-extrabold leading-[1.08] tracking-tight text-black mb-6">
        ...
        <div className="max-w-6xl mx-auto mt-6">
          <p className="text-sm text-gray-400 italic">
            ...
            <strong className="text-gray-600">100% authentic.</strong>
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeSection>
            <h2 className="text-3xl sm:text-[40px] font-extrabold leading-[1.1] tracking-tight text-black mb-5">
          ...
          <FadeSection>
            <div className="relative w-full" style={{ paddingTop: "108%" }}>
              <iframe
                ...
                allow="autoplay"
                className="absolute top-0 left-0 h-full w-full rounded-2xl shadow-xl"
              />
            </div>
          </FadeSection>
        </div>
      ...
      <section className="py-24 px-4 text-center bg-white">
        <div className="max-w-3xl mx-auto">
          <FadeSection>
            <h2 className="text-4xl sm:text-5xl lg:text-[56px] font-extrabold leading-[1.05] tracking-tight text-black mb-5">
              Try ClearPix now!
            </h2>
