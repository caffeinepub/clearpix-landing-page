...
> = {
  "unblur-sharpener": {
    ...
    imageBefore: `${B}unblur-sharpener-hero-before.webp`,
    imageAfter: `${B}unblur-sharpener-hero-after.webp`,
    sections: [
      {
        ...
        image: `${B}unblur-sharpener-crisp-images.webp`,
        imageRight: true,
      },
      {
        tagline: "Use cases",
        ...
        image: `${B}unblur-sharpener-details.webp`,
        imageRight: false,
      },
      {
        tagline: "Quality",
        ...
        image: `${B}unblur-sharpener-super-sharp.webp`,
        imageRight: true,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        image: `${B}usecase-denoiser-after.webp`,
        imageRight: true,
      },
      {
        tagline: "Night shots",
        ...
        image: `${B}usecase-denoiser-before.webp`,
        imageRight: false,
      },
      {
        tagline: "Quality",
        ...
        image: `${B}usecase-unblur-after.webp`,
        imageRight: true,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        image: `${B}usecase-photo-restorer-before.webp`,
        imageRight: true,
      },
      {
        ...
        image: `${B}usecase-photo-restorer-after.webp`,
        imageRight: false,
      },
      {
        tagline: "Heritage",
        ...
        image: `${B}usecase-face-enhancer-after.webp`,
        imageRight: true,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        image: `${B}usecase-image-enlarger-after.webp`,
        imageRight: true,
      },
      {
        tagline: "Print Ready",
        ...
        image: `${B}usecase-image-enlarger-before.webp`,
        imageRight: false,
      },
      {
        tagline: "Web & Social",
    ...
    sections: [
      {
        ...
        image: `${B}usecase-color-fixer-after.webp`,
        imageRight: true,
      },
      {
        tagline: "Old Photos",
        ...
        image: `${B}usecase-color-fixer-before.webp`,
        imageRight: false,
      },
      {
  ...
  "face-enhancer": {
    ...
    sections: [
      ...
      },
      {
        ...
        image: `${B}usecase-face-enhancer-before.webp`,
        imageRight: false,
      },
      {
  ...
  "background-enhancer": {
    ...
    sections: [
      ...
      },
      {
        ...
        image: `${B}homepage-video-enhancer.webp`,
        imageRight: true,
      },
    ],
  },
  "low-quality-enhancer": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Old Android, CCTV footage, scanned documents, screenshots — if it's low quality, ClearPix can fix it.",
        image: `${B}usecase-unblur-after.webp`,
        imageRight: true,
      },
    ],
  ...
  "video-enhancer": {
    ...
    imageAfter: `${B}homepage-video-enhancer.webp`,
    sections: [
      {
        tagline: "Video AI",
