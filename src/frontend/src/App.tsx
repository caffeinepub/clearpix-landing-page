...
// Using locally generated original images (no external CDN dependencies)
...
> = {
  "unblur-sharpener": {
    ...
    imageAfter: `${LOCAL}unblur-after.dim_400x300.jpg`,
    sections: [
      {
        ...
        image: `${LOCAL}unblur-after.dim_400x300.jpg`,
        imageRight: true,
      },
      {
        tagline: "Use cases",
        ...
        image: `${LOCAL}unblur-before.dim_400x300.jpg`,
        imageRight: false,
      },
      {
        tagline: "Quality",
  ...
  denoiser: {
    ...
    imageBefore: `${LOCAL}denoiser-before.dim_400x300.jpg`,
    imageAfter: `${LOCAL}denoiser-after.dim_400x300.jpg`,
    sections: [
      {
        tagline: "Technology",
        ...
        image: `${LOCAL}denoiser-after.dim_400x300.jpg`,
        imageRight: true,
      },
      {
        tagline: "Night shots",
        ...
        image: `${LOCAL}denoiser-before.dim_400x300.jpg`,
        imageRight: false,
      },
      {
        tagline: "Quality",
  ...
  "photo-restorer": {
    ...
    imageBefore: `${LOCAL}oldphoto-before.dim_600x400.jpg`,
    imageAfter: `${LOCAL}oldphoto-after.dim_600x400.jpg`,
    sections: [
      {
        tagline: "Restoration",
        ...
        image: `${LOCAL}oldphoto-before.dim_600x400.jpg`,
        imageRight: true,
      },
      {
  ...
  "image-enlarger": {
    ...
    imageBefore: `${LOCAL}portrait-before.dim_600x400.jpg`,
    imageAfter: `${LOCAL}portrait-after.dim_600x400.jpg`,
    sections: [
      {
  ...
  "color-fixer": {
    ...
    imageBefore: `${LOCAL}color-before.dim_400x300.jpg`,
    imageAfter: `${LOCAL}color-after.dim_400x300.jpg`,
    sections: [
      {
      ...
      },
      {
        ...
        image: `${LOCAL}color-before.dim_400x300.jpg`,
        imageRight: false,
      },
      {
  ...
  "face-enhancer": {
    ...
    imageBefore: `${LOCAL}face-before.dim_400x300.jpg`,
    imageAfter: `${LOCAL}face-after.dim_400x300.jpg`,
    sections: [
      {
        tagline: "Facial AI",
      ...
      },
      {
        ...
        image: `${LOCAL}face-before.dim_400x300.jpg`,
        imageRight: false,
      },
      {
